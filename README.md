...
Pseudonymizing requires a list of txt or docx documents to be processed, with outputs (including a mapping file, linking pseudonym-codes to the replaced text) saved in a Pseudon subdirectory. Depseudonymizing requires a list of txt or docx documents to be processed and the associated mapping file.
